...
The equation is 
Div(grad(Az)) - u e w^2 Az + i w u s Az= 0

div(grad((Az)) + b Az + i c Az = 0 with b = - u e w^2 and c = w u s

and then split in real and imag parts
div(grad(Azr)) + i div(grad((Azi)) + b Azr + i b Azi + i c Azr - c Azi = 0
and in two equations
div(grad(Azr)) + b Azr - c Azi = 0
div(grad((Azi)) + b Azi + c Azr = 0


Assembly will be ...
as shown above the equations are..
div(grad(Azr)) + b Azr - c Azi = 0
div(grad((Azi)) + b Azi + c Azr = 0
...
but here I learn a lot woith block structure.
