...
int ProximityEffect::PostPrecessing()
{
   ...
   // compute Jr   
   PWConstCoefficient K;
   {   
      real_t CoeffArray[]={omega_*sigma_, 0.0, 0.0, 0.0, 0.0};
      Vector CoeffVector(CoeffArray, 5);
      K.UpdateConstants(CoeffVector);
   }
   ProductCoefficient Jr1Coeff(K, AziGFCoeff);

   {
      real_t CoeffArray[]={-sigma_, 0.0, 0.0, 0.0, 0.0};
      Vector CoeffVector(CoeffArray, 5);
      K.UpdateConstants(CoeffVector);
   }
   ProductCoefficient Jr2Coeff(Vr, K);
   ...
   ProductCoefficient Ji1Coeff(K, AzrGFCoeff);
   ...
   ProductCoefficient Ji2Coeff(Vi, K);
